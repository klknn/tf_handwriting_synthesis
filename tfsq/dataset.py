...
STATS = {
    ...
    'max_stroke_len': 1940,
    'max_text_len': 64,
    'mean': np.array([3.52694747e+03, 3.27328457e+03, 1.37348168e+07], dtype=np.float32),
    'stddev': np.array([2.71751375e+04, 2.54106321e+04, 1.01035389e+08], dtype=np.float32),
    'num_vocab': 81,
